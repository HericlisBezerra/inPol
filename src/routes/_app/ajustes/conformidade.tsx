...
import { FieldHint, PanelHeader } from "./-ui";

export const Route = createFileRoute("/_app/ajustes/conformidade")({
  head: () => ({ meta: [{ title: "Auditoria e retenção — Ajustes" }] }),
  component: Screen,
});
...
/**
 * Ajustes · Conformidade (antes /ajustes/auditoria — renomeada porque a tela não é só
 * a trilha: ela também guarda a retenção e o atendimento a titulares da LGPD).
 *
 * Aqui estão as duas ações mais destrutivas do app — expurgo e exclusão de titular —
 * e nenhuma dizia o que perdia. Agora cada uma declara o efeito antes da confirmação.
 */
function Screen() {
  ...
  return (
    <div>
      <PanelHeader
        ...
        description="Trilha imutável de acessos, prazo de guarda e direitos de titulares."
        effect={
          <>
            O prazo de retenção apaga mensagens <b className="text-v2-ink">de verdade</b>: passado o
            prazo, elas somem de Sinais e deixam de alimentar relatórios novos. A trilha em si é
            imutável e exportável para a ANPD.
          </>
        }
        action={
          <button
      ...
      <div className="mt-4 flex flex-col gap-3 sm:flex-row">
        <div className="flex-1 rounded-xl border border-v2-line bg-v2-card px-4 py-[13px]">
          ...
          <FieldHint>
            Cada abertura de conteúdo bruto por alguém da equipe gera um registro.
          </FieldHint>
        </div>
        <div className="flex-1 rounded-xl border border-v2-line bg-v2-card px-4 py-[13px]">
          ...
          <FieldHint>
            Mensagens mais antigas que isso são apagadas na próxima limpeza automática.
          </FieldHint>
        </div>
        <div className="flex-1 rounded-xl border border-v2-line bg-v2-card px-4 py-[13px]">
          ...
          <FieldHint>
            {confirmingPurge
              ? "Apaga agora, em definitivo, toda mensagem fora do prazo de retenção. Não há desfazer."
              : "Antecipa a limpeza automática. Apaga em definitivo o que já passou do prazo."}
          </FieldHint>
        </div>
      </div>
      ...
      <FieldHint>
        A tela mostra os 200 eventos mais recentes. O CSV exporta a trilha inteira — é ele que serve
        como peça de conformidade.
      </FieldHint>
      ...
      <div className="mt-3.5 rounded-[13px] border border-v2-line bg-v2-card px-5 py-3.5">
        ...
        <p className="mb-2.5 max-w-[64ch] text-[12px] leading-normal text-v2-ink-3">
          Informe o hash do autor (LGPD art. 18) para exportar ou excluir as mensagens dele nesta
          organização. <b className="text-v2-ink">Exportar</b> só lê e conta.{" "}
          <b className="text-v2-ink">Excluir</b> apaga em definitivo todas as mensagens daquele
          titular — elas somem de Sinais e dos relatórios gerados daqui pra frente, sem desfazer.
        </p>
        ...
        {confirmingDelete && (
          <div className="mt-2 text-[11.5px] font-[650] leading-snug text-v2-crit">
            Confirmar apaga em definitivo todas as mensagens deste titular nesta organização. Não há
            desfazer.
          </div>
        )}
      </div>
