...
export const Route = createFileRoute("/_app/ajustes/acesso/perfil")({
...
/**
 * Ajustes · Quem acessa · Meu perfil (antes /ajustes/perfil).
 * Dados reais (profiles + storage `avatars`).
 *
 * É a única tela de Ajustes cujo efeito é puramente cosmético — e por isso ela precisa
 * dizer isso: nome e foto não mudam permissão nenhuma, mas são o que a equipe vê ao
 * lado das ações registradas na trilha de auditoria.
 */
function Screen() {
  ...
  return (
    <div>
      <PanelHeader
        title="Meu perfil"
        description="Como você aparece para a equipe. Só você edita seu nome e sua foto."
        effect={
          <>
            Nome e foto são identificação, não permissão: mudá-los não altera nada do que você pode
            ver ou fazer. É este nome que a equipe encontra ao lado das suas ações na trilha de
            auditoria.
          </>
        }
      />
        ...
        <div className="mt-4 space-y-4">
          ...
          <div className="flex items-center gap-4 rounded-[13px] border border-v2-line bg-v2-card px-5 py-4">
            ...
            <div className="min-w-0">
              ...
              />
              <FieldHint>
                A imagem fica num endereço público — não use foto que não possa ser vista por quem
                receber o link.
              </FieldHint>
            </div>
          </div>
          ...
          <div className="rounded-[13px] border border-v2-line bg-v2-card px-5 py-4">
            ...
            />
            <FieldHint>
              Aparece na lista de Equipe e ao lado das suas ações na trilha de auditoria.
            </FieldHint>
            ...
            <FieldHint>
              O e-mail de acesso não muda por aqui — ele é a sua credencial de login.
            </FieldHint>
