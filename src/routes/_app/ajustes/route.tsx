...
const NAV_ITEMS: { to: string; label: string; exact?: boolean }[] = [
  ...
  { to: "/ajustes/eleitos", label: "Eleitos (TSE)" },
  { to: "/ajustes/notificacoes", label: "Notificações" },
  { to: "/ajustes/equipe", label: "Equipe e acesso" },
  { to: "/ajustes/organizacoes", label: "Organizações" },
  { to: "/ajustes/auditoria", label: "Auditoria LGPD" },
];
