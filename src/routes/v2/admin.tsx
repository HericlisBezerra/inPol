...
export const Route = createFileRoute("/v2/admin")({
  head: () => ({ meta: [{ title: "Admin — Inpol v2" }] }),
  component: Screen,
});
...
function Screen() {
  return (
    <div className="flex flex-col gap-4">
      {/* Faixa de identificação do modo admin (o design usa header escuro + badge dourado) */}
      <div className="flex flex-wrap items-center gap-4 rounded-xl bg-v2-ink px-5 py-3">
        <span className="rounded bg-v2-gold px-2 py-[3px] font-mono text-[9.5px] font-bold tracking-[0.1em] text-v2-ink">
          ADMIN PLATAFORMA
        </span>
