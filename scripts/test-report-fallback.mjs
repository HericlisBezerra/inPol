...
const data = {
  ...
  city: "Jundiaí",
  counts: {
    messages_analyzed: 4564,
    alerts: { vermelho: 1, laranja: 2, amarelo: 3 },
    by_source: { whatsapp: 4000, news: 500, instagram: 64 },
  },
  top_topics: [
    {
      label: "Enchentes",
  ...
  top_neighborhoods: [
    {
      ...
      count: 438,
      avg_sentiment: -0.6,
      top_topics: [{ label: "Enchentes", count: 200 }],
    },
  ],
  ...
  external_signals: [
    {
      source: "news",
      label: "Tribuna",
      title: "Enchente na Vila Rami",
      url: "https://x",
      excerpt: "moradores relatam abandono",
      risk_score: 88,
    },
  ],
  high_risk_messages: [
    {
      text: "esperei 5 horas na UBS",
      risk: 71,
      topic: "Saúde",
      neighborhood: "Retiro",
      source: "whatsapp",
  ...
  sample_alerts: [
    {
      ...
      topic: "Enchentes",
      neighborhood: "Vila Rami",
      summary: "sem resposta da prefeitura",
    },
  ],
};
...
ok(
  r1.includes("4564") && r1.includes("Enchentes") && r1.includes("Vila Rami"),
  "traz números e dados reais",
);
...
const empty = {
  org: null,
  city: null,
  counts: { messages_analyzed: 0, alerts: { vermelho: 0, laranja: 0, amarelo: 0 }, by_source: {} },
  top_topics: [],
  top_neighborhoods: [],
  top_opponents: [],
  external_signals: [],
