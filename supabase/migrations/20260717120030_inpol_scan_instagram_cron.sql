-- Recreated (not applied) definition of the pg_cron job "inpol-scan-instagram",
...
--   where jobname = 'inpol-scan-instagram';
--
--   jobid: 8 | schedule: '0 */2 * * *' | active: true
--
...
--     'inpol-scan-instagram',
--     '0 */2 * * *',
--     $$
--     select net.http_post(
--       url := 'https://<new-domain>/api/public/hooks/scan-instagram',
...
--   $$
--   SELECT net.http_post(
--     url:='https://project--fab025bf-498e-4c1d-a0be-6a6ab1563132.lovable.app/api/public/hooks/scan-instagram',
