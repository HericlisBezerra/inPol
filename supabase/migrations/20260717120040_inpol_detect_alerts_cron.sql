-- Recreated (not applied) definition of the pg_cron job "inpol-detect-alerts",
...
--   where jobname = 'inpol-detect-alerts';
--
--   jobid: 10 | schedule: '*/30 * * * *' | active: true
--
...
--       url := 'https://<new-domain>/api/public/hooks/detect-alerts',
...
--   $$
--   SELECT net.http_post(
--     url:='https://project--fab025bf-498e-4c1d-a0be-6a6ab1563132.lovable.app/api/public/hooks/detect-alerts',
