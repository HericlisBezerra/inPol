-- Recreated (not applied) definition of the pg_cron job "inpol-purge-retention",
...
--   where jobname = 'inpol-purge-retention';
--
--   jobid: 12 | schedule: '0 3 * * *' | active: true
--
...
--     'inpol-purge-retention',
--     '0 3 * * *',
--     $$
--     select net.http_post(
--       url := 'https://<new-domain>/api/public/hooks/purge-retention',
...
--   $$
--   SELECT net.http_post(
--     url:='https://project--fab025bf-498e-4c1d-a0be-6a6ab1563132.lovable.app/api/public/hooks/purge-retention',
